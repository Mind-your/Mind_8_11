...
function dropNav(own){
  ...
  own.children[1].innerHTML = `<div class="nav-login-drop">
                                    <a href="${str}/login.html">
                                        <button type="button" class="nav-drop-btn">Paciente</button>
                                    </a>
                                    <a href="${str}/login.html">
                                        <button type="button" class="nav-drop-btn">Psicólogo</button>
                                        <button type="button" class="nav-drop-btn">Voluntário</button>
                                    </a>
                                </div>`
